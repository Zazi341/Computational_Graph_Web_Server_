...
/**
 * Logical OR agent that performs bitwise OR operations on two input values.
 * 
 * <p>OrAgent implements the {@link Agent} interface to provide bitwise OR functionality
 * in the computational graph system. This agent subscribes to two input topics, waits for
 * numeric values from both, and publishes the bitwise OR result to an output topic.</p>
 * 
 * <p><strong>Bitwise OR Operation:</strong></p>
 * <ul>
 *   <li>Converts input decimal values to integers</li>
 *   <li>Performs bitwise OR operation (a | b)</li>
 ...
 * <pre>
 * # Configuration file format for OR agent
 * configs.OrAgent          # Agent class name
 ...
 * <pre>{@code
 * // Configuration creates an OR agent that:
 * // 1. Subscribes to "signal_a" and "signal_b" topics
 * // 2. Performs bitwise OR when both values are received
 * // 3. Publishes result to "or_output" topic
 * 
 * // Example computation:
 * // Input: signal_a = 5.0 (binary: 101), signal_b = 3.0 (binary: 011)
 * // Output: or_output = 7.0 (binary: 111, decimal: 7)
 * }</pre>
 * 
 ...
 * 
 * @see Agent
 * @see BitwiseUtils#bitwiseOr(double, double)
 * @see AndAgent
 * @see XorAgent
 * @since 1.0
 */
public class OrAgent implements Agent {
	//---------------------------------------------------
	/** The fixed name identifier for this OR agent instance. */
    ...
    /**
     * Constructs a new OrAgent with the specified input and output topics.
     * 
    ...
    /**
     * Returns the fixed name identifier for this OR agent.
     * 
     * @return always returns "OrAgent"
     */
    @Override
    ...
    /**
     * Resets the internal state of this OR agent by clearing input values and flags.
     * 
    ...
    /**
     * Processes incoming messages and performs bitwise OR operations when both inputs are available.
     * 
     * <p>This method implements the core OR gate logic:</p>
     * <ol>
     ...
     *   <li>When both valid inputs are available, performs bitwise OR operation</li>
     ...
     * </ul>
     * 
     * <p><strong>Computation Trigger:</strong> The bitwise OR operation is performed
    ...
    public void callback(String topic, Message msg) {
        ...
        if (xSet && ySet) {
            double result = BitwiseUtils.bitwiseOr(x, y);
    ...
    /**
     * Performs cleanup when the OR agent is no longer needed.
     * 
